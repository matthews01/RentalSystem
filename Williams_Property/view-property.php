...
<div class="container-fluid">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
          ...
          <div class="item <?= $i == 1 ? 'active' : '' ?>">
              <img class="d-block img-fluid" src="owner/<?php echo $photo ?>" alt="Slide <?php echo $i ?>" width="100%" style="max-height: 600px; min-height: 600px;">
          </div>
          <?php } ?>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <table>
            ...
            <tr>
              <td><h3>Booked:</h3></td>
              <td><h4><?php echo isset($rows['Booked']) ? $rows['Booked'] : 'N/A'; ?></h4></td>
            </tr>
            <tr>
  ...
  <form method="POST">
    <div class="row">
      <div class="col-sm-6">
        <?php
        $booked = isset($rows['Booked']) ? $rows['Booked'] : 'N/A';
        if ($booked == 'No'){ ?>
...
<?php } else { ?>
  <center><h3>You should login to book property.</h3></center>
<?php } ?>
...
<div class="container-fluid">
  ...
  <div class="well well-sm">
    ...
    <?php } else { ?>
      <center>You should login to review property.</center>
    <?php } ?>
  </div> 
</div>
...
echo '<div class="container-fluid"><h3>Reviews:</h3></div>';
if (mysqli_num_rows($query) > 0) {

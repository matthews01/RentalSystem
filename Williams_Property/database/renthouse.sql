...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2024 at 03:10 PM
...
(123, 'United States of America', 'New York', 'Clatsop', 'Queens', 'New York', 'Municipality', 3, 'Brooklyn', 3477078368, 'Full House Rent', 2000, 4, 3, 1, 1, 1, 'Nice for a couple honeymoon stay.', 27.679130, 85.327872, 1),
(124, 'United States of America', 'New York', 'New York', 'Queens', 'New York', 'Municipality', 14, 'Corona Park', 3477078368, 'Full House Rent', 4500, 12, 5, 2, 1, 3, 'This is a beautiful property located near Corona Park, Queens.', 27.679130, 85.327872, 1);
...
(1, 'rajj.williams@gmail.com', '12345');
...
INSERT INTO `chat` (`chat_id`, `message`, `property_id`, `tenant_id`, `timestamp`) VALUES
(1, 'hello', 0, 18, '2024-07-16 10:31:58');
...
(1, 'Rajahani Williams', 'rajj.williams@gmail.com', '12345', 987654321, 'Queens-3', 'Citizenship', 'owner-photo/nikesh.png'),
(2, 'Rajahani Williams', 'rajj.williams1@gmail.com', '123123', 717207370, '1008-90115', 'Citizenship', 'owner-photo/avatar.png'),
(3, 'Rajahani Williams', 'williams@gmail.com', '456456', 717207370, '1008-90115', 'Citizenship', 'owner-photo/avatar.png');
...
(7, 'This property is nice', 0, 124),
(8, 'I love this property, i will come and book it again, the utilities are top notch', 5, 123);
...
(18, 'Rajahani Williams', 'rajj.williams@gmail.com', '12345', 3477078368, '00000', 'Citizenship', 'tenant-photo/avatar.png');
...
--
ALTER TABLE `chat`
  ADD CONSTRAINT `chat_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `tenant` (`tenant_id`);
